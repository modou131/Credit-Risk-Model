...
# Path to the save model and it's components
MODEL_PATH = 'credit_risk_model_data.joblib'
...
def prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,
    ...
    input_data = {
        ...
        'loan_purpose_Home': 1 if residence_type == 'Home' else 0,
...
def predict(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency, delinquency_ratio, credit_utilization_ratio, num_open_accounts, residence_type, loan_purpose, loan_type):
    ...
    # Prepare input data
    input_df = prepare_input(age, income, loan_amount, loan_tenure_months, avg_dpd_per_delinquency,delinquency_ratio, credit_utilization_ratio, num_open_accounts, residence_type,
